...
export default function AppLayout() {
  ...
  const navByRole = {
    CoOwner: [
      ...
      { to: '/co-owner/reports-management', label: 'Quản lý Báo cáo' },
      { to: '/co-owner/notification-management', label: 'Quản lý Thông báo' },
      { to: '/co-owner/voting-management', label: 'Quản lý Bình chọn' },
